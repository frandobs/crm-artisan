...
import { createJobSiteAction, type JobSiteState } from '@/lib/actions/job-sites'
import type { Client } from '@/lib/clients'

export default function NewJobSiteForm({ clients }: { clients: Client[] }) {
  const [state, action, pending] = useActionState<JobSiteState, FormData>(createJobSiteAction, null)
  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
      ...
      <div className="screen-header gap-3">
        ...
        <h1 className="screen-title">New job site</h1>
      </div>

      <form action={action} className="flex flex-col gap-5 p-4 pb-10">
